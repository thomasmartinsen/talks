    ...
    <div className="app-container" data-theme={themeMode}>
      <header className="app-header">
        <div className="header-toolbar">
          <fieldset className="toggle-switch theme-toggle" aria-label="Color theme selection">
            ...
            >
              ...
              <span className="visually-hidden">Use light mode</span>
            </button>
            <button
              className="toggle-option"
            ...
            >
              ...
              <span className="visually-hidden">Use dark mode</span>
            </button>
          </fieldset>
        </div>
