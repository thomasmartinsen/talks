...
| ----- | -------------- | ----- | ---------- |
| 1     | Core utilities | 2     | 20-30      |
| 2     | Business logic | 3     | 25-35      |
...
1. **Be specific** - Include exact file paths, method names, inputs, and expected outputs for each test case
2. **Be comprehensive** - Aim for 80%+ code coverage; don't artificially cap test counts. A well-tested 3-file project may need 50–80 tests. Err on the side of more coverage, not less.
